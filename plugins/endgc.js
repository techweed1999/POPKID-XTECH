...
cmd({
  ...
  try {
    ...
    if (_0x112bfc !== _0x5ad0e2) {
      return _0x1cd54a("【POPKIF】💥XTECH💥【ＭＤ\n\n】Only the bot owner can use this command.");
    }
    if (!_0x119769) {
      return _0x1cd54a("【POPKID】😇XTECH💥【ＭＤ】\n\nI need to be an admin to execute this command.");
    }
...
cmd({
  ...
  try {
    if (!_0x437d8e) {
      return _0x454a95("【XTECH】💥POPKID💥【ＭＤ】\n\nThis command can only be used in groups.");
    }
...
cmd({
  ...
  try {
    ...
    if (!_0x1db97d) {
      return _0x477905("【POPKID】💥XTECH💥【ＭＤ】\n\nI need to be an admin to execute this command.");
    }
