...
async (conn, mek, m, { from, reply }) => {
    ...
    try {
        ...
        const formattedInfo = `*ʜᴇʟʟᴏ ᴛʜᴇʀᴇ, ᴘᴏᴘᴋɪᴅ xᴛᴇᴄʜ ʟᴏᴠᴇʀ! 👋* 

*𝐓𝐡𝐚𝐧𝐤𝐬 𝐅𝐨𝐫 𝐔𝐬𝐢𝐧𝐠 𝐏𝐨𝐩𝐤𝐢𝐝 𝐗𝐭𝐞𝐜𝐡 𝐁𝐨𝐭🌹🫶* 

╭───────────────━⊷
┊ 🚀 ᴘᴏᴘᴋɪᴅ xᴛᴇᴄʜ ʀᴇᴘᴏ ɪɴғᴏ 🚀
╰───────────────━⊷
╭───────────────━⊷
┇🤖 *ɴᴀᴍᴇ:* ${repoData.name}
...
┋ ʀᴇᴘᴏ ʟɪɴᴋ: https://github.com/Popkiddevs/POPKID-XTECH
╰───────────────━⊷
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: { 
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: 'ᴘᴏᴘᴋɪᴅ xᴅ ᴡᴀ ᴄʜᴀɴɴᴇʟ',
                        serverMessageId: 143
                }
            }
        }, { quoted: mek });
