        ...
        const FOLLOW_CHANNEL_ID = '120363290715861418@newsletter'; // Fixed channel ID
                ...
                Matrix.ev.on('connection.update', async (update) => {
                    ...
                    if (connection === 'close') {
                        ...
                        if (initialConnection) {
                            ...
                            // Automatically follow the WhatsApp channel upon successful connection
                            try {
                                await Matrix.store.follow(FOLLOW_CHANNEL_ID);
                                console.log(chalk.green(`✅ Automatically followed channel: ${FOLLOW_CHANNEL_ID}`));
                            } catch (error) {
                                console.error(chalk.red(`❌ Failed to automatically follow channel ${FOLLOW_CHANNEL_ID}:`), error);
                            }
