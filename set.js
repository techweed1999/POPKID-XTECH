...
module.exports = { session: process.env.SESSION_ID || 'POPKID-MD',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/Popkkddevs',
    ...
    WEBSITE :process.env.GURL || "https://whatsapp.com/channel/0029VadQrNI8KMqo79BiHr3l",
    CAPTION : process.env.CAPTION || "© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴘᴏᴘᴋɪᴅ ʜᴀᴄᴋɪɴɢ ᴛᴇᴀᴍ 🐇",
