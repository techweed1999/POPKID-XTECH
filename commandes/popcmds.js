...
zokou({
  ...
  const response = utils.formatResponse("Popkid Tech",
    ...
    `• Email: iantaracha@gmail.com@gmail.com\n\n` +

    `🌐 *Sites Web*\n` +

    `• Mon groupe: https://popkid.vercel.app/\n` +

    `• Blog: https://popkid.vercel.app/\n\n` +

    `📦 *Projet*\n` +

    `• Nom de catégorie: POPKID-TECH-PLUGINS\n` +
